...
class TutorProfileActivity : AppCompatActivity(), View.OnClickListener, ProfileListener,GetImageListener,SaveImageListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userInfo.observe(this, Observer {
            try {
                Log.i("thingy","triggered")
                Log.i("name:", it.get(0))
                nameEditText.setText(it.get(0))
                ageEditText.setText(it.get(1))
                profileEmailEditText.setText(it.get(2))
                zipcodeEditText.setText(it.get(3))
                phoneNumberEditText.setText(it.get(4))
                SubjectsEditText.setText(it.get(5))
                highestDegreeEditText.setText(it.get(6))
                SchoolEditText.setText(it.get(7))
                graduationEditText.setText(it.get(8))
                costRateEditText.setText(it.get(9))
                descriptionEditText.setText(it.get(10))
            } catch (e:Exception){
